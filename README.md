...
- 出題者が問題を出題し、回答者はYESかNOで答えられる質問をする<br>例. ◯それは生き物ですか？ ×それはなんという生き物ですか？
...
# 目的
- 初めて0から作るWEBアプリなら楽しいものが良い！と考えた。
- コミュニケーションを取りながら、親しい友人・知人数人で遊べるゲームを作ってみたい！と考えた。

# 工夫した点
- ロードを挟まずに、リアルタイムにチャットができるシステムを作ろうと考え、ActionCableを導入した。
- 全体的に楽しそうな雰囲気を意識しつつ、文字を見やすくすることを心掛けた。
- CSVファイルから、問題を簡単にまとめて追加できるようにした。
